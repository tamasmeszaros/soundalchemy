...
typedef struct snd_hwdep_dsp_image {
	...
	#define SNDRV_HWDEP_IOCTL_INFO _IOR ('H', 0x01, snd_hwdep_info_t)
	#define SNDRV_HWDEP_IOCTL_DSP_STATUS _IOR('H', 0x02, snd_hwdep_dsp_status_t)
	#define SNDRV_HWDEP_IOCTL_DSP_LOAD _IOW('H', 0x03, snd_hwdep_dsp_image_t)
...
typedef struct snd_rawmidi_status {
	...
	#define SNDRV_RAWMIDI_IOCTL_INFO _IOR('W', 0x01, snd_rawmidi_info_t)
	#define SNDRV_RAWMIDI_IOCTL_PARAMS _IOWR('W', 0x10, snd_rawmidi_params_t)
	#define SNDRV_RAWMIDI_IOCTL_STATUS _IOWR('W', 0x20, snd_rawmidi_status_t)
...
typedef struct snd_timer_status {
	...
	#define SNDRV_TIMER_IOCTL_NEXT_DEVICE _IOWR('T', 0x01, snd_timer_id_t)
	#define SNDRV_TIMER_IOCTL_TREAD _IOW('T', 0x02, int)
	#define SNDRV_TIMER_IOCTL_GINFO _IOWR('T', 0x03, snd_timer_ginfo_t)
	#define SNDRV_TIMER_IOCTL_GPARAMS _IOW('T', 0x04, snd_timer_gparams_t)
	#define SNDRV_TIMER_IOCTL_GSTATUS _IOWR('T', 0x05, snd_timer_gstatus_t)
	#define SNDRV_TIMER_IOCTL_SELECT _IOW('T', 0x10, snd_timer_select_t)
	#define SNDRV_TIMER_IOCTL_INFO _IOR('T', 0x11, snd_timer_info_t)
	#define SNDRV_TIMER_IOCTL_PARAMS _IOW('T', 0x12, snd_timer_params_t)
	#define SNDRV_TIMER_IOCTL_STATUS _IOR('T', 0x14, snd_timer_status_t)
...
typedef struct snd_ctl_tlv {
	...
	#define SNDRV_CTL_IOCTL_ELEM_LOCK _IOW('U', 0x14, snd_ctl_elem_id_t)
	#define SNDRV_CTL_IOCTL_ELEM_UNLOCK _IOW('U', 0x15, snd_ctl_elem_id_t)
	#define SNDRV_CTL_IOCTL_SUBSCRIBE_EVENTS _IOWR('U', 0x16, int)
	#define SNDRV_CTL_IOCTL_ELEM_ADD _IOWR('U', 0x17, snd_ctl_elem_info_t)
	#define SNDRV_CTL_IOCTL_ELEM_REPLACE _IOWR('U', 0x18, snd_ctl_elem_info_t)
	#define SNDRV_CTL_IOCTL_ELEM_REMOVE _IOWR('U', 0x19, snd_ctl_elem_id_t)
	#define SNDRV_CTL_IOCTL_TLV_READ _IOWR('U', 0x1a, snd_ctl_tlv_t)
	#define SNDRV_CTL_IOCTL_TLV_WRITE _IOWR('U', 0x1b, snd_ctl_tlv_t)
	#define SNDRV_CTL_IOCTL_TLV_COMMAND _IOWR('U', 0x1c, snd_ctl_tlv_t)
	#define SNDRV_CTL_IOCTL_HWDEP_NEXT_DEVICE _IOWR('U', 0x20, int)
	#define SNDRV_CTL_IOCTL_HWDEP_INFO _IOR('U', 0x21, snd_hwdep_info_t)
	#define SNDRV_CTL_IOCTL_PCM_NEXT_DEVICE _IOR('U', 0x30, int)
	#define SNDRV_CTL_IOCTL_PCM_INFO _IOWR('U', 0x31, snd_pcm_info_t)
	#define SNDRV_CTL_IOCTL_PCM_PREFER_SUBDEVICE _IOW('U', 0x32, int)
	#define SNDRV_CTL_IOCTL_RAWMIDI_NEXT_DEVICE _IOWR('U', 0x40, int)
	#define SNDRV_CTL_IOCTL_RAWMIDI_INFO _IOWR('U', 0x41, snd_rawmidi_info_t)
...
struct snd_xferv {
	...
	#define SNDRV_IOCTL_READV _IOW('K', 0x00, struct snd_xferv)
	#define SNDRV_IOCTL_WRITEV _IOW('K', 0x01, struct snd_xferv)
